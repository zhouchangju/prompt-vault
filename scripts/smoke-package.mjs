...
try {
  ...
  execFileSync(process.execPath, ['node_modules/@playwright/test/cli.js', 'test', '--grep', 'create once|all themes|original v1|manager whole cards|panel one-click|actual native',
